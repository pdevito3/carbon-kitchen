<template>
  <div class="flex space-x-1 sm:space-x-2 md:space-x-1 lg:space-x-2">
    ...
    <span v-if="pageState=='view'" class="shadow-sm rounded-md">
      <button
        @click="editRecipe()"
        type="button"
        class="inline-flex items-center px-3 sm:px-4 py-2 border border-gray-300 text-sm leading-5 font-medium rounded-md text-gray-700 bg-white hover:text-gray-500 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 active:text-gray-800 active:bg-gray-50 active:text-gray-800 transition duration-150 ease-in-out"
    ...
    <div class="flex items-center justify-center">
      <span v-if="pageState=='edit'" class="shadow-sm rounded-l-md">
        <button
          @click="saveRecipe()"
          type="button"
    ...
    <span
      class="hidden relative shadow-sm rounded-md"
    >
      <button
        @click="open = !open"
        type="button"
